    ...
    const init = async () => {
      ...
      if (svcs) {
        ...
        const colorMap: Record<string, ServiceColor> = {
          ...
          Bolt: { color: "#2563EB", bgColor: "#DBEAFE" },
          Droplets: { color: "#1D4ED8", bgColor: "#DBEAFE" },
          Cctv: { color: "#3B82F6", bgColor: "#EFF6FF" },
          Network: { color: "#2563EB", bgColor: "#DBEAFE" },
          Laptop: { color: "#334155", bgColor: "#F8FAFC" },
          Printer: { color: "#334155", bgColor: "#F8FAFC" },
          Cpu: { color: "#334155", bgColor: "#F8FAFC" },
          Router: { color: "#2563EB", bgColor: "#EFF6FF" },
          Wifi: { color: "#2563EB", bgColor: "#EFF6FF" },
          Cable: { color: "#2563EB", bgColor: "#EFF6FF" },
          PlusCircle: { color: "#2563EB", bgColor: "#DBEAFE" },
          Settings: { color: "#2563EB", bgColor: "#DBEAFE" },
          ShieldCheck: { color: "#2563EB", bgColor: "#DBEAFE" },
          Smartphone: { color: "#2563EB", bgColor: "#EFF6FF" },
          Users: { color: "#3B82F6", bgColor: "#DBEAFE" },
          AirVent: { color: "#0EA5E9", bgColor: "#F0F9FF" },
          Truck: { color: "#2563EB", bgColor: "#EFF6FF" },
          Sofa: { color: "#64748B", bgColor: "#F8FAFC" },
          Hammer: { color: "#64748B", bgColor: "#F8FAFC" },
          Monitor: { color: "#334155", bgColor: "#F8FAFC" },
          Star: { color: "#3B82F6", bgColor: "#DBEAFE" },
          Blocks: { color: "#2563EB", bgColor: "#DBEAFE" },
          Wrench: { color: "#1D4ED8", bgColor: "#EFF6FF" },
        };
