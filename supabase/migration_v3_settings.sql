...
CREATE TABLE IF NOT EXISTS public.system_settings (
    ...
    apk_backup_download_url TEXT DEFAULT 'https://github.com/hoaitv86/thodenngay/releases/latest/download/thodenngay.apk',
    updated_at TIMESTAMPTZ DEFAULT NOW() NOT NULL
);

ALTER TABLE public.system_settings
ADD COLUMN IF NOT EXISTS apk_backup_download_url TEXT DEFAULT 'https://github.com/hoaitv86/thodenngay/releases/latest/download/thodenngay.apk';
